module.exports = {
	...
	usage: ()=> [" - Displays help for all commands.",
				...
				" [module] - Displays help for a module"],
	execute: async (bot, msg, args) => {
		...
		if(bot.modules.get(bot.mod_aliases.get(args.join(" ").toLowerCase()))) {
			let module = bot.modules.get(bot.mod_aliases.get(args.join(" ").toLowerCase()));
